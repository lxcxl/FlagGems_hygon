...
from flag_gems.ops.bitwise_or import bitwise_or_tensor_

logger = logging.getLogger(__name__)


def ior_tensor(self, other):
    """In-place bitwise OR through the tensor dunder method with a tensor operand.

    Thin wrapper that reuses the existing ``bitwise_or_tensor_`` kernel —
